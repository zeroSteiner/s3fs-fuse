...
static constexpr char help_string[] =
    ...
    "\n"
    "   stat_version (default is 1)\n"
    "        Controls how the file stat information is used in the S3 Headers.\n"
    "        1: The original s3fs-fuse stat format (decimal mode, Unix timestamps).\n"
    "        2: rclone compatible stat format (octal mode, ISO 8601 timestamps).\n"
    "\n"
    "FUSE/mount Options:\n"
    "\n"
